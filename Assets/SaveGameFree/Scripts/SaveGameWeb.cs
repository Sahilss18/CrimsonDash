...
using CrimsonDash.SaveGameFree.Encoders;
using CrimsonDash.SaveGameFree.Serializers;

namespace CrimsonDash.SaveGameFree
{
	...
	public class SaveGameWeb
	{
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="CrimsonDash.SaveGameFree.SaveGameWeb"/> default encode.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="CrimsonDash.SaveGameFree.SaveGameWeb"/> is encode.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CrimsonDash.SaveGameFree.SaveGameWeb"/> class.
		/// </summary>
