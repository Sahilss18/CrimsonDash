...
Crimson Dash, Awesome 2D Platformer Game.
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/db74f1c8-1e92-401e-9524-1dbda191d74c" />
</p>
...
Follow the below instructions to get started with Crimson Dash source code:
...
You can get access to Crimson Dash source code by using one of the following ways:

- [:sparkles: Download Source Code](https://github.com/Sahilss18/CrimsonDash/archive/master.zip)
- Clone the repository locally:

```bash
git clone https://github.com/Sahilss18/CrimsonDash.git
```
...
- [Games on GitHub](https://github.com/leereilly/games/) - 🎮 A list of popular/awesome video games, add-ons, maps, etc. hosted on GitHub.
...
MIT @ [Sahil Singh](https://github.com/Sahilss18)

Made with :heart: by [Sahil Singh](https://github.com/Sahilss18)
